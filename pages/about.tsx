...
const AboutPage = observer(() => (
  <Container as="main" className="mx-auto p-4" style={{ maxWidth: '1000px' }}>
    ...
    <section className="my-5">
      ...
      <p className="text-center fst-italic mt-2">显示部分历史活动，完整列表请参考原文档</p>
    </section>
    ...
    <section className="my-5">
      ...
      <ol className="fs-5 lh-lg">
        ...
        <li>继续坚持做好两周一次的【Coffee and Code】的结对编程活动、编程道场活动，一对一指导开发者提升个人技术能力。</li>
        <li>做好季度技术专场活动，让成都众多 IT 公司加入其中进行分享，带动成都 IT 圈子技术分享的热情。</li>
        <li>做好成都 Web 前端交流大会，让国内一线技术大咖来到成都，给成都众多开发者带来国内一线开发公司的技术心得与经验。</li>
        <li>联合成都众多大型 IT 公司，做好编程马拉松活动，让成都的众多开发者进行技术火花的碰撞。</li>
      </ol>
    </section>
        ...
        <div className="col-md-6 mb-4">
          <div className="card h-100 shadow-sm">
            <div className="card-body">
              ...
              <p className="card-text">2017 成都 Web 前端交流大会 (6 分 53 秒处)</p>
            </div>
          </div>
        </div>
        <div className="col-md-6 mb-4">
          <div className="card h-100 shadow-sm">
            <div className="card-body">
              <h4 className="card-title text-primary">四川财富广播 FM94.0 采访</h4>
              <p className="card-text">FCC 成都社区：“人人皆可编程”，以独特的方式为城市带来美好改变</p>
            </div>
          </div>
        </div>
        <div className="col-md-6 mb-4">
          <div className="card h-100 shadow-sm">
            <div className="card-body">
              ...
              <p className="card-text">揭秘“黑客马拉松”：喝 6 瓶红牛、24 小时里只睡 2 小时</p>
            </div>
          </div>
        </div>
      </div>
